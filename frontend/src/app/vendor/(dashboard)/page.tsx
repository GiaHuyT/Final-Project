                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="md:col-span-2 p-8 rounded-xl bg-white border border-slate-100 shadow-sm relative overflow-hidden flex flex-col justify-between min-h-[220px]">
                        <div className="relative z-10">
                            <span className="text-[10px] uppercase tracking-widest font-bold text-slate-500 mb-2 block">Tổng số lượng Xe đang bán</span>
                            <h3 className="text-5xl font-extrabold tracking-tighter text-slate-900">{stats?.totalProducts || 0}</h3>
                            <div className="mt-4 flex items-center gap-2 text-green-600 font-bold text-sm">
                                <span className="material-symbols-outlined text-sm">trending_up</span>
                                <span>Kinh doanh khả quan</span>
                            </div>
                        </div>
                    ...
                    <div className="p-8 rounded-xl bg-slate-50 border border-slate-100 flex flex-col justify-between">
                        <div>
                            ...
                            <span className="text-[10px] uppercase tracking-widest font-bold text-slate-500 block">Dịch vụ (Sửa chữa)</span>
                            <h3 className="text-3xl font-extrabold tracking-tight mt-1 text-slate-900">{stats?.totalRepairs || 0}</h3>
                        </div>
