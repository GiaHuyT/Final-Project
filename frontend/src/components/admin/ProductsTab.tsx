...
export function ProductsTab() {
    ...
    const validateForm = () => {
        ...
        const required = ['vendorId', 'name', 'brand', 'modelName', 'price', 'year', 'fuelType', 'transmission'];
                        ...
                        <div className="max-w-4xl mx-auto space-y-16 pb-24 min-h-0">
                            ...
                            <section id="section-0" className="scroll-mt-12">
                                ...
                                <div className="space-y-4 p-6 bg-blue-50/50 rounded-3xl border border-blue-100">
                                    ...
                                    {formErrors.vendorId && <span className="text-red-500 text-[10px] italic">{formErrors.vendorId}</span>}
                                </div>
                            </section>
