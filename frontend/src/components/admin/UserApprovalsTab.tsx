        ...
        <div className="space-y-6 flex-1">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        <div className="relative w-full md:w-80 group">
                            ...
                            <Input
                                ...
                                className="pl-12 h-12 rounded-2xl bg-white border-gray-100 focus:ring-4 focus:ring-gray-200 font-bold transition-all shadow-sm"
                                value={searchQuery}
                                                ...
                                                <td className="px-10 py-6 align-middle">
                                                    <div className="flex items-center gap-4">
                                                        <Avatar className="h-12 w-12 border-2 border-white shadow-md">
                                                            ...
                                                            <AvatarFallback className="bg-gray-900 text-white font-black">
                                                ...
                                                <td className="px-10 py-6 align-middle text-right">
                                                    <div className="flex justify-end gap-2">
                                                        ...
                                                        <Button 
                                                            ...
                                                            className="h-10 px-4 rounded-xl bg-gray-900 text-white hover:bg-black border-none transition-all active:scale-95 flex items-center gap-2 font-black text-xs uppercase tracking-tight shadow-lg shadow-gray-200"
                                                        >
            ...
            <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
                <DialogContent className="sm:max-w-[480px] p-0 border-none shadow-3xl rounded-[2.5rem] overflow-hidden">
                    <div className="bg-gradient-to-r from-gray-900 to-black h-32 relative">
                    ...
                    <div className="p-6 bg-gray-50/80 border-t flex justify-end gap-3">
                         ...
                         <Button 
                            ...
                            className="bg-gray-900 hover:bg-black text-white font-black rounded-xl px-6"
                         >
                            Phê duyệt ngay
                         </Button>
                    </div>
